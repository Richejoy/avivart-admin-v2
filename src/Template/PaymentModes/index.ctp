    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $paymentMode->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $paymentMode->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $paymentMode->id], ['confirm' => __('Are you sure you want to delete # {0}?', $paymentMode->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
