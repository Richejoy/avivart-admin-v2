 ...
 * @method \App\Model\Entity\OrderState|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\OrderState saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 ...
 * @method \App\Model\Entity\OrderState findOrCreate($search, callable $callback = null, $options = [])
 */
