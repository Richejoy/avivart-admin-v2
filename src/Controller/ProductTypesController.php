...
class ProductTypesController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            $productType->image = $this->ProductTypes->Images->patchEntity(
                $this->ProductTypes->Images->newEntity(),
                [
                    'folder' => 'product_types',
                    'url' => 'default.jpg',
                    'link' => self::IMG_PROD_URL . 'product_types/default.jpg'
                ]
            );
        ...
        $images = $this->ProductTypes->Images->find('list', ['limit' => 200]);
        $this->set(compact('productType', 'images'));
    }
