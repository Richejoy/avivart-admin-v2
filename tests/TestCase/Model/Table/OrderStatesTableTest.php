...
class OrderStatesTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('OrderStates') ? [] : ['className' => OrderStatesTable::class];
        $this->OrderStates = TableRegistry::getTableLocator()->get('OrderStates', $config);
    }
