...
class ContactsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'contact_topic_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'contact_topic_id' => ['type' => 'index', 'columns' => ['contact_topic_id'], 'length' => []],
        ],
        '_constraints' => [
