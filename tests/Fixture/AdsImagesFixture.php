 ...
 * AdsImagesFixture
 */
class AdsImagesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['ad_id', 'image_id'], 'length' => []],
            'id' => ['type' => 'unique', 'columns' => ['id'], 'length' => []],
            'ads_images_ibfk_1' => ['type' => 'foreign', 'columns' => ['ad_id'], 'references' => ['ads', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'ads_images_ibfk_2' => ['type' => 'foreign', 'columns' => ['image_id'], 'references' => ['images', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
