...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'products_ibfk_1' => ['type' => 'foreign', 'columns' => ['image_id'], 'references' => ['images', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'products_ibfk_2' => ['type' => 'foreign', 'columns' => ['product_category_id'], 'references' => ['product_categories', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'products_ibfk_3' => ['type' => 'foreign', 'columns' => ['product_type_id'], 'references' => ['product_types', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'products_ibfk_4' => ['type' => 'foreign', 'columns' => ['currency_id'], 'references' => ['currencies', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'products_ibfk_5' => ['type' => 'foreign', 'columns' => ['conversion_id'], 'references' => ['conversions', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'products_ibfk_6' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
